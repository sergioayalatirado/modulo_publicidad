...
<body>
    ...
    <div class="container">
        <form action="../php/editar_publicidad.php" method="POST" enctype="multipart/form-data">
                ...
                <h6><br>
                    ...
                    if (!($tipo_archivo == 'imagen' || $tipo_archivo == 'audio' || $tipo_archivo == 'video')) {
                        ...
                        ?>   
                            ...
                            <img src="multimedia/<?php echo $archivo ?>" alt="" width="200"><br>
                        <?php
                        } 
            ...
            <br>
            <input type="text" hidden value="<?= $row['id_publicidad'] ?>" name="id" id="id_publicidad">
            <button type="submit" class="btn btn-primary" name="actualizar" text-center>Actualizar publicidad</button>
        </form>
    </div>
</body>
